...
def generate_reason(query, description, flower_name, flower_meaning, emotion, target):
    prompt = PromptTemplate(
        ...
        [작성 지침]
        1. 쉼표(,)의 사용을 피하고 자연스럽게 문장을 이어주세요.
        2. {flower}는 첫 문단에서 자연스럽게 등장시켜 주세요. 그 꽃의 상징성과 분위기를 간결하게 요약해 주세요.
        3. {meaning}은 중심 메시지로 삼되 감정이 담기게 풀어주세요. 단 그대로 반복하지 않고 창의적이고 자연스럽게 녹여주세요.
        4. 추천 이유는 구매자가 '{target}'에게 전하고 싶은 감정이 진심처럼 느껴지도록 써주세요.
        5. 전체 문장은 2~3개의 짧은 문단으로 나누고, 존댓말을 사용하세요.
        6. 감정({emotion})에 따라 다음 어조 스타일을 반영해 주세요:
        - 슬픔: 조용하고 따뜻하게
        - 응원: 희망차고 긍정적으로
        - 사랑: 깊고 섬세하게
        - 축하: 경쾌하고 발랄하게
